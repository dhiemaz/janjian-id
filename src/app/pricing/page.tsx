        ...
        <main className="flex min-h-screen flex-col items-center justify-between p-1" data-theme="light">
            ...
            <section className="py-24 ">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-12">
                        <h2 className="font-manrope text-5xl text-center font-bold text-gray-900 mb-4">Choose the best plan for you </h2>
                        <p className="text-gray-500 text-center leading-6 mb-9">Paid plan not available yet. Don&apos;t worry you can choose free plan with minimum features.</p>

                        {/*<div className="flex justify-center items-center">*/}
                        {/*    <label className="min-w-[3.5rem] text-xl relative text-gray-900 mr-4 font-medium">Bill*/}
                        {/*        Monthly</label>*/}
                    ...
                    <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                        <div
                            ...
                            <ul className="mb-12 space-y-6 text-left text-lg text-gray-500">
                                ...
                                <li className="flex items-center space-x-4">
                                    ...
                                    <span>Connect one of your calendars </span>
                                </li>
                                <li className="flex items-center space-x-4">
                                ...
                                <li className="flex items-center space-x-4">
                                    ...
                                    <span>Embed scheduling on your site</span>
                                </li>
                            ...
                            <div className="p-6 xl:py-9 xl:px-12">
                                ...
                                <ul className="mb-12 space-y-6 text-left text-lg ">
                                    <li className="flex items-center space-x-4">
                                        ...
                                        <span className="font-bold">Free feature included</span>
                                    </li>
                                    <li className="flex items-center space-x-4">
                                    ...
                                    <li className="flex items-center space-x-4">
                                        ...
                                        <span>Automate reminders & more</span>
                                    </li>
                                </ul>
                                <Link href="#" className="py-2.5 px-5 btn-disabled shadow-sm rounded-full transition-all duration-500 text-base text-white font-semibold text-center w-fit block mx-auto hover:bg-indigo-700">Not
                                    Available</Link>
                        ...
                        <div
                            ...
                            <Link href="#"
                                  className="py-2.5 px-5 btn-disabled shadow-sm rounded-full transition-all duration-500 text-base text-white font-semibold text-center w-fit mx-auto hover:bg-indigo-700">Not
                                Available</Link>
                        </div>
                    </div>

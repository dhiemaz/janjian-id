...
export default function PricingPage() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-1" data-theme="light">
            <Navbar/>
            <div className="font-[sans-serif] max-w-6xl mx-auto relative bg-white rounded-lg py-6 z-0">
                <div className="grid lg:grid-cols-3 items-center">
                    ...
                    <div className="lg:col-span-2 bg-[#0a4275] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
                        <h2 className="text-3xl text-white text-center font-bold mb-6">Get In Touch</h2>
                        <form>
                            <div className="max-w-md mx-auto space-y-3">
                                ...
                                <button type='button'
                                        className="text-white w-full relative bg-blue-500 hover:bg-blue-600 font-semibold rounded-lg text-sm px-6 py-3 !mt-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                                         fill='currentColor' className="mr-2 inline" viewBox="0 0 548.244 548.244">

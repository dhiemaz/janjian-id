    ...
    return (
        <div className="navbar sticky top-0 z-10 bg-white accent-primary navbar-nav px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div className="navbar-end px-1 space-x-4 lg:flex">
                <Link href="/login"
                      className="text-black bg-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-black font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-white dark:hover:bg-gray-600 dark:focus:ring-black hidden">
                    Log In
                </Link>

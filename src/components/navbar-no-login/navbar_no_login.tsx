        ...
        <div className="navbar sticky top-0 z-10 bg-white accent-primary navbar-nav px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div className="navbar-end px-1 space-x-4 lg:flex">
                ...
                <Link href="/registration"
                      className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 visible lg:invisible">
                    Get Started
                </Link>
